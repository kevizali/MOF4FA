...
![image](https://github.com/user-attachments/assets/78082000-0873-410c-924e-cff09c80c6a6)

Contents
1. MOFs_for_FA_removal: This database is the list of reported MOFs used to remove FA. This is the training database for the gen AI models used to predict new hMOFs.
2. pred_MOF_for_FA: This database consist of the list of MOFs predicted by gen AI models.
3. training_db: This database contains the list of MOFs used to remove FA as a training database for the AI models.
